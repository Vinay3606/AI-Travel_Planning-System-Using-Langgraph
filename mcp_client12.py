...
client= MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport":  "stdio",
            "command": r"C:\Users\ASUS\Desktop\ips clg\flight_multiagentproject\aviationstack-mcp\.venv\Scripts\python.exe",
                    "args": [
                        "-m",
                        "aviationstack_mcp",
                        "mcp",
                    ...
                    "env": {
                        "AVIATION_STACK_API": AVIATION_STACK_API_KEY
                    }
        ...
        "weather" : {
                "transport" : "stdio",
                 "command": r"C:\Users\ASUS\Desktop\ips clg\flight_multiagentproject\myenvi\Scripts\python.exe",
                "args": [
                    r"C:\Users\ASUS\Desktop\ips clg\flight_multiagentproject\custom_weathermcp.py"
                ],
                "env": {
